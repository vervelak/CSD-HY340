...
/*
enum Vmopcode{
   	add_v=0,	sub_v=1,	mul_v=2,
   	div_v=3,	mod_v=4,	and_v=5,
   	or_v=6,	jeq_v=7,	jne_v=8,
   	jle_v=9,	jge_v=10,	jlt_v=11,
   	jgt_v=12,	tablegetelem_v=13,
   	tablesetelem_v=14,	assign_v=15, uminus_v=16,
   	not_v=17,	call_v=18,	jump_v=19,
   	pusharg_v=20, getretval_v=21, funcenter_v=22,
   	funcexit_v=23, tablecreate_v=24, ret_v=25,
   	nop_v=26//26
};
*/
